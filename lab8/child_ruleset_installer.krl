...
ruleset child_ruleset_installer {
    ...
    rule install_wovyn_emulator {
        ...
        event:send({ 
            ...
            "attrs": {
                "absoluteURL": "file:///Users/byu/cs462/lab8/wovyn_emulator.krl",
                "rid": "wovyn_emulator",
                "config": {}
            }
        })
    ...
    rule install_sensor_profile {
        ...
        event:send({ 
            ...
            "type": "install_ruleset_request",
            "attrs": {
                "absoluteURL": "file:///Users/byu/cs462/lab8/sensor_profile.krl",
                "rid": "sensor_profile",
                "config": {}
            }
        })
    ...
    rule install_wovyn_base {
        ...
        event:send({ 
            ...
            "type": "install_ruleset_request",
            "attrs": {
                "absoluteURL": "file:///Users/byu/cs462/lab8/wovyn_base.krl",
                "rid": "wovyn_base",
                "config": {}
            }
        })
